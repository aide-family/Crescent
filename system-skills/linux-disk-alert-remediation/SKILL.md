...
- Treat the alert host and mount as the scope. For an alert like `10.42.131.142 /home`, keep the investigation centered on host `10.42.131.142` and filesystem `/home`.
