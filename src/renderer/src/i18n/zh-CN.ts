const zhCN = {
  ...
  input: {
    ...
    slashConnection: '引用当前连接',
    slashConnectionDescription: '插入当前 SSH 连接信息',
    slashMode: '引用对话模式',
    slashModeDescription: '插入当前 Agent 模式',
    slashModel: '引用模型',
    slashModelDescription: '插入当前供应商和模型',
    slashSkill: '引用 Skill',
    ...
    slashSkills: '引用 Skills 规则',
    slashSkillsDescription: '插入选择并读取 skill 的执行要求',
    slashTerminal: '引用终端',
