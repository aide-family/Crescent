const zhCN = {
  ...
  connections: {
    ...
    moveToBottom: '置底',
    host: '主机',
    clusterHostRegex: '集群主机正则',
    clusterHostRegexDescription: '可选。配置后，只要终端主机名匹配该正则，即视为已登录到目标环境。',
    clusterHostRegexPlaceholder: '例如 ^node-\\d+(\\.cluster\\.local)?$',
    identityFile: '密钥文件',
    importAsNew: '导入为新连接',
    loginActions: '登录动作',
  ...
  settings: {
    ...
    subagentsEnabled: '子智能体',
    subagentsEnabledHint:
      '允许主智能体委派 scout / reviewer / worker 等任务。每个子智能体占用一个停靠子终端，主终端命令仍在当前窗格执行。',
