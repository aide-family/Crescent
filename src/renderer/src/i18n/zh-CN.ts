const zhCN = {
  ...
  input: {
    ...
    toolArgs: '参数',
    toolOutput: '输出',
    toolWorkspaceHint: '在 Agent 工作区执行（不会写入终端面板）。',
    ...
    currentTerminal: 'Agent 的 bash/read/write/edit 在工作区目录执行，不会写入此终端面板。',
    ...
    emptyConversationHint:
      '可以向 Crescent 询问集群或工作区问题。bash 工具在 Agent 工作区执行；交互式 shell 请用终端面板。',
  ...
  settings: {
    ...
    piToolsTitle: 'Pi 工具',
    piToolsHint:
      'Agent 使用 Pi 内置工具（read、write、edit、bash）在工作区执行，不会驱动终端面板。OpenAPI/MCP 与终端命令类 Agent 工具已移除。',
