const en = {
  app: {
    ...
    layoutGroup: 'Workbench layout',
    layoutSplit: 'Chat and terminal',
    layoutChat: 'Chat only',
    layoutTerminal: 'Terminal only',
    running: 'Running',
  ...
  common: {
    ...
    contextUsagePending: 'Waiting for next turn',
  ...
  connections: {
    ...
    host: 'Host',
    clusterHostRegex: 'Cluster host pattern',
    clusterHostRegexDescription:
      'Optional. A matching terminal hostname (glob like *.gd17.* or regex like ^node-\\d+$) counts as already logged in.',
    clusterHostRegexPlaceholder: 'e.g. *.gd17.* or ^node-\\d+$',
    clusterHostRegexInvalid: 'Cluster host pattern is not a valid glob or regular expression.',
    clusterHostRegexTooLong: 'Cluster host pattern must be at most {max} characters.',
    clusterHostRegexTooComplex: 'Cluster host pattern looks too complex; simplify it.',
    saveMissingName: 'Enter a connection name.',
    saveMissingHost: 'Enter a host.',
  ...
  terminal: {
    ...
    agentExecuting: 'AI executing',
    interruptCommand: 'Interrupt command (Ctrl+C)',
    commandRunningHidden: 'Command running in hidden terminal',
  ...
  input: {
    ...
    slashCompactDescription: 'Summarize older model context; the chat timeline is kept',
    compactContext: 'Compact context',
  ...
  settings: {
    ...
    workbenchLayoutHint: 'Applies immediately and is restored the next time Crescent opens.',
  ...
  "mcpServers": {
    ...
    providerEnabledHint:
      'Disabled providers stay saved, but their models cannot be selected in conversations.',
