const en = {
  ...
  input: {
    ...
    toolArgs: 'Arguments',
    toolOutput: 'Output',
    toolWorkspaceHint: 'Runs in the agent workspace (not the terminal panel).',
    ...
    currentTerminal:
      'Agent bash/read/write/edit tools run in the workspace cwd, not in this terminal panel.',
    ...
    emptyConversationHint:
      'Ask Crescent about your cluster or workspace. Bash tools run in the agent workspace; use the terminal panel for interactive shells.',
  ...
  settings: {
    ...
    piToolsHint:
      'The agent uses Pi built-in tools (read, write, edit, bash) in the workspace cwd. They do not drive the terminal panel. OpenAPI/MCP agent tools and terminal command tools have been removed.',
