...
export function RendererCrashLoopPanel({ t }: { t: Dictionary }): React.JSX.Element {
  return (
    <div className="flex min-h-screen flex-col items-center justify-center gap-4 bg-background p-8 text-center">
      <h1 className="text-lg font-semibold text-foreground">{t.recovery.crashLoopTitle}</h1>
      <p className="max-w-md text-sm text-muted-foreground">{t.recovery.crashLoopBody}</p>
