...
export class AgentMemory {
  ...
  rememberTurn(userInput: string, assistantOutput: string): void {
    ...
    const assistantRecord: AgentMemoryRecord = { role: 'assistant', content: assistantOutput, createdAt }
