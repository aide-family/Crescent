...
export class AgentPromptBuilder {
  ...
  private buildToolGuidanceBlock(mode: string, terminalToolsEnabled: boolean): string {
    const terminalGuidance = terminalToolsEnabled
      ? [
          'When terminal execution is needed, call execute_terminal_command. Default target is the current/focused terminal in this chat session. When the terminal context lists peer terminals for the same session, pass targetTerminalId to run on a specific peer PTY.',
