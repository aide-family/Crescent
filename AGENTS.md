...
3. Follow project skills `crescent-host`, `crescent-login-intent`, and `crescent-delivery-gate`, plus `pi-dev`, `electron-dev`, `electron`, and `desktop-app-design`. Do not adopt Electron EGG (`ee-core`).
